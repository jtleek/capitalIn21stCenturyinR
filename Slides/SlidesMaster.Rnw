...
### Load Libraries:
# setwd("~/R/capital21c/Slides")# temp for convenience
library(ggplot2)
library(scales)
library(xlsx)
library(reshape2)
...
ts1.1 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter0TablesFigures.xlsx",
  sheetName = "TSI.1", rowIndex = 7:107, colIndex = 1:2, header = FALSE)
names(ts1.1) <- c("Year", "top_10_is")
df1.1 <- melt(ts1.1, id.vars = "Year")

## Figure 1.2 / TS1.2
ts1.2 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter0TablesFigures.xlsx",
...
## Figure 5.3 / TS5.1
ts5.1 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
## Figure 5.3b / TS5.2
ts5.2 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
## Figure 5.4 / TS5.12
ts5.12 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
## Figure 5.6 / TS5.11
ts5.11 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
ts5.3 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
ts5.5 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
## Figure 5.8 / CTS12.3
cts12.3 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
...
## Figure 8.1 /  TS8.1
ts8.1 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter8TablesFigures.xlsx",
...
names(df8.1) <- c("Year", "Income", "Wage")
df8.1 <- melt(df8.1, id.vars = c("Year"))
# remove years < 1910, which have many NAs: start rowIndex at 16

## Figure 8.5 /  TS8.2
ts8.2 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter8TablesFigures.xlsx",
...
# Europe
ts9.4 <- read.xlsx("../Github/Piketty2014FiguresTables/Chapter9TablesFigures.xlsx",
...
## Figure 14.1 / TS14.1
ts14.1 = read.xlsx("../Github/Piketty2014FiguresTables/Chapter14TablesFigures.xlsx", 
...
## Figure 14.2 / TS14.2
ts14.2 = read.xlsx("../Github/Piketty2014FiguresTables/Chapter14TablesFigures.xlsx", 
