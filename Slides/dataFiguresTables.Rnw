...
TS5.11 <- melt(TS5.11, id.vars = "Year")
...
TS5.12 <- melt(TS5.12, id.vars = "Year")
...
cTS12.3 <- melt(cTS12.3, id.vars = "Year")
save(cTS12.3, file = "data/cTS12.3.Rda")

# Figure 5.1 / CTS4.5 / private & public capital / USA & Europe
load("data/cTS4.5.Rda")
df_5_1 <- subset(cTS4.5, variable %in% c("United States", "Europe") & Category %in% c("Private capital", "Public capital"))
row.names(df_5_1) <- NULL
save(df_5_1, file = "data/df_5_1.Rda")

# Figure 5.2 / CTS4.5 / national & foreign capital / USA & Europe
load("data/cTS4.5.Rda")
df_5_2 <- subset(cTS4.5, variable %in% c("United States", "Europe") & Category %in% c("National capital", "Net foreign capital"))
...
load("data/TS5.1.Rda")
df_5_3 <- subset(TS5.1, variable %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
load("data/TS5.12.Rda")
df_5_4 <- subset(TS5.12, variable %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
load("data/TS5.3.Rda")
load("data/TS5.5.Rda")
df_5_7S <- merge(TS5.3, TS5.5, by = c("Year", "variable"))
...
names(TS6.4) <- c("Year", "Share of housing in national income (net of depreciation)", "Share of gross profits in gross value added", "Share of net profits in net value added (net of capital depreciation)", "Share of capital income in national income", "After-tax Share of capital income (excluding retained earnings)")
...
load("data/TS6.4.Rda")
df_6_8 <- TS6.4[, c("Year", "Share of capital income in national income")]
df_6_8 <- melt(df_6_8, id.vars = "Year")
save(df_6_8, file = "data/df_6_8.Rda")

# Figure 6.8 / TS6.4 / capital income share / France
load("data/TS6.4.Rda")
df_6_8S <- TS6.4[, c("Year", "Share of capital income in national income", "After-tax Share of capital income (excluding retained earnings)")]
...
names(TS11.1a) <- c("Year", "Annual inheritance flow \n(% of national income): Economic flows", "Annual inheritance flow \n(% national income): Fiscal flows", "Annual inheritance flow \n(% disposable income): Economic flows", "Annual inheritance flow \n(% disposable income): Fiscal flows", "Adult mortality rate \n(adults aged 20 and over)", "Average age of decedents \n(adults aged 20 and over)", "Average age of inheritors \n(direct line)", "Ratio of average wealth at death to average wealth \nof the decedents and the living", "Ratio of average wealth at death to average wealth \nof the decedents and the living, \n(including bequest gifts made before death)", "Annual inheritance flow \n(% aggregate private wealth): Economic flows", "Simulated annual inheritance flow: scenario 1", "Simulated annual inheritance flow: scenario 2")
...
names(TS11.1b) <- c("Year", "Inheritance share (% total lifetime resources): Scenario 1", "Inheritance (% labor resources): Scenario 1", "Living standard of top 1% inheritance (% of bottom 50% labor earners lifetime resources): Scenario 1", "Living standard of top 1% labor earners (% of bottom 50% labor earners lifetime resources): Scenario 1", "Inheritance share (% total lifetime resources): Scenario 2", "Inheritance (% labor resources): Scenario 2", "Living standard of top 1% inheritance (% of bottom 50% labor earners lifetime resources): Scenario 2", "Living standard of top 1% labor earners (% of bottom 50% labor earners lifetime resources): Scenario 2", "Cohort fraction receiving in inheritance more than the bottom 50% labor resources (scenario 2)")
...
names(TS11.2a) <- c("Year", "Share of the non-capitalized inherited wealth (Modigliani) (scenario 1)", "Share of the non-capitalized inherited wealth (Modigliani) (scenario 2)", "Share of the capitalized inherited wealth (KS1) (Kotlikoff-Summers, r=3%, 30yrs) (scenario 1)", "Share of the capitalized inherited wealth (KS1) (Kotlikoff-Summers, r=3%, 30yrs) (scenario 2)", "Share of the capitalized inherited wealth (KS2) (Kotlikoff-Summers, observed rate of return) (scenario 1)", "Share of the capitalized inherited wealth (KS2) (Kotlikoff-Summers, observed rate of return) (scenario 2)", "Share of the capitalized inherited wealth (PPVR definition, estimate) (scenario 1)", "Share of the capitalized inherited wealth (PPVR definition, estimate) (scenario 2)")
...
names(TS11.2b) <- c("Year", "Share of the non-capitalized inherited wealth (Modigliani) ", "Share of the capitalized inherited wealth (KS1) (Kotlikoff-Summers, r=3%, 30yrs)", "Share of the capitalized inherited wealth (KS2) (Kotlikoff-Summers, observed rate of return)", "Share of the capitalized inherited wealth (PPVR definition)")
...
df_11_1 <- TS11.1a[, c("Year", "Annual inheritance flow \n(% of national income): Economic flows", "Annual inheritance flow \n(% national income): Fiscal flows")]
...
load("data/TS11.1a.Rda")
df_11_2 <- TS11.1a[, c("Year", "Adult mortality rate \n(adults aged 20 and over)")]
...
load("data/TS11.1a.Rda")
df_11_3 <- TS11.1a[, c("Year", "Average age of decedents \n(adults aged 20 and over)", "Average age of inheritors \n(direct line)")]
df_11_3 <- melt(df_11_3, id.vars = "Year")
save(df_11_3, file = "data/df_11_3.Rda")

# Figure 11.4 / TS11.1a / inheritance flow + mortality / France
load("data/TS11.1a.Rda")
df_11_4 <- TS11.1a[, c("Year", "Annual inheritance flow \n(% aggregate private wealth): Economic flows", "Adult mortality rate \n(adults aged 20 and over)")]
...
load("data/TS11.1a.Rda")
df_11_5 <- TS11.1a[, c("Year", "Ratio of average wealth at death to average wealth \nof the decedents and the living\n", "Ratio of average wealth at death to average wealth \nof the decedents and the living, \n(including bequest gifts made before death)\n")]
...
load("data/TS11.1a.Rda")
df_11_6 <- TS11.1a[, c("Year", "Annual inheritance flow \n(% of national income): Economic flows", "Simulated annual inheritance flow: scenario 1", "Simulated annual inheritance flow: scenario 2")]
...
load("data/TS11.1a.Rda")
df_11_8 <- TS11.1a[, c("Year", "Annual inheritance flow \n(% disposable income): Economic flows", "Annual inheritance flow \n(% disposable income): Fiscal flows")]
names(df_11_8) <- c("Year", "Economic flows \n(annual inheritance flow % disposable income, \ncomputed from national wealth estimates, mortality tables, and age-wealth profiles)\n", "Fiscal flows: \n(annual inheritance flow % disposable income, \ncomputed from bequest and gift tax data, including tax-exempt assets)\n")
