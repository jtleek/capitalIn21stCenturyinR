...
load("data/TS5.1.Rda")
df_5_3 <- subset(TS5.1, Country %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
load("data/TS5.12.Rda")
df_5_4 <- subset(TS5.12, Country %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
load("data/TS5.2.Rda")
df_5_5X <- subset(TS5.2, Country %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
df_5_5 <- subset(df_5_5S, Country %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
df_5_7 <- subset(df_5_7S, Country %in% c("United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia"))
...
names(TS12.3) <- c("Year", "Number of bilionaires in dollars", "Total wealth in billions of dollars", "Total wealth of billionaires as a fraction of aggregate private wealth", "Number of billionaires per 100 million adults", "Share of the top 1/20 million highest wealth holders in gobal private wealth", "Share of top 1/100 million highest wealth holders in gobal private wealth")
...
names(TS12.5) <- c("Year", "Europe", "United States", "Japan", "Rich countries (Europe, Japan, United States)", "Unregistered financial assets registered in tax havens (lower estimate)")
save(TS12.5, file = "data/TS12.5.Rda")

# Figure 12.1 / TS12.3
load("data/TS12.3.Rda")
df_12_1 <- TS12.3[, c("Year", "Number of bilionaires in dollars", "Total wealth in billions of dollars")]
