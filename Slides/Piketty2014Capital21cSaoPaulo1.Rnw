...
opts_chunk$set(echo = FALSE, comment = NA, concordance = TRUE)

# Set figure size and resolution
opts_chunk$set(dev = c('pdf','png'), fig.path = 'figures/color/', fig.height = 5, fig.width = 10, dpi = 300)
...
df1.1 <- melt(ts1.1, id.vars = c("Year"))
names(df1.1) <- c("Year", "variable", "value")
...
df1.2 <- melt(ts1.2, id.vars = c("Year"))
names(df1.2) <- c("Year", "variable", "value")
...
df5.3 <- melt(ts5.1, id.var = "Year")
names(df5.3) <- c("Year", "variable", "Private")
...
df5.3b <- melt(ts5.2, id.var = "Year")
names(df5.3b) <- c("Year", "variable", "Public")
...
df5.4 <- melt(ts5.12, id.var = "Year")
names(df5.4) <- c("Year", "variable", "Private")

## Figure 5.5 / TS5.1 + TS5.2
df5.5 <- merge(df5.3, df5.3b, by = c("Year", "variable"))
df5.5 <- melt(df5.5, id.var = c("Year", "variable"))
names(df5.5) <- c("Year", "variable", "Type", "Capital")
...
names(df9.4b) <- c("Year", "value")
df9.8 <- merge(df8.2b, df9.4b, by = c("Year"))
names(df9.8) <- c("Year", "US", "Europe")
df9.8 <- melt(df9.8, id.var = c("Year"))
...
df14.1 <- melt(df14.1, id.var = "Year")
names(df14.1) <- c("Year", "variable", "Rate")
...
df14.2 <- melt(ts14.2, id.var = "Year")
names(df14.2) <- c("Year", "variable", "Rate")
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.1.1, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE>>=
ggplot(data = df1.1, aes(x = Year, y = value)) + geom_line(colour = colorPalette[1]) + geom_point(shape = shapePalette[1], size = 3, colour = colorPalette[1]) + ylab("Share of top decile in national income") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = seq(.3, .5, by = .05)) + scale_x_continuous(breaks = seq(1910, 2010, by = 10))
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.8.5, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE>>=
ggplot(data = df8.5, aes(x = Year, y = value, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(group = variable, shape = variable, colour = variable), size = 3) + ylab("Share of top decile in national income") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = seq(.3, .5, by = .05)) + scale_x_continuous(breaks = seq(1910, 2010, by = 10)) + scale_shape_manual(name = "Share of top decile in national income", values = shapePalette[1:2]) + scale_colour_manual(name = "Share of top decile in national income", values = colorPalette[1:2]) + theme(legend.key = element_blank(), legend.position = c(.6, .75), legend.background = element_rect(colour = 'black')) 
@
\caption{The top decile share in U.S. national income dropped from 45--50\% in the 1910s--1920s to less than 35\% in the 1950s (this is the
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.1.2, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE>>=
ggplot(data = df1.2, aes(x = Year, y = value, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Market value of private capital (% national income)") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = pretty_breaks(n = 5)) + scale_x_continuous(breaks = pretty_breaks(n = 8)) + scale_shape_manual(name = "Country", values = shapePalette[1:3]) + scale_colour_manual(name = "Country", values = colorPalette[1:3]) + theme(legend.key = element_blank(), legend.position = c(.75, .75), legend.background = element_rect(colour = 'black')) 
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.5.3, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE, warning = FALSE>>=
# Spain included, to remove replace df with df[df['variable'] != "Spain",]
ggplot(data = df5.3, aes(x = Year, y = Private, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Value of private capital (% national income)") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = pretty_breaks(n = 6)) + scale_x_continuous(breaks = seq(1970, 2010, by = 5)) + scale_shape_manual(name = "Country", values = shapePalette[1:9]) + scale_colour_manual(name = "Country", values = colorPalette[1:9]) + theme(legend.key = element_blank(), legend.position = c(.15, .86), legend.background = element_rect(colour = 'black')) + guides(shape = guide_legend(ncol = 3)) 
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.5.4, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE, warning = FALSE>>=
# Spain included, to remove replace df with df[df['variable'] != "Spain",]
ggplot(data = df5.4, aes(x = Year, y = Private, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Private capital (% disposable household income)") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = pretty_breaks(n = 6)) + scale_x_continuous(breaks = seq(1970, 2010, by = 5)) + scale_shape_manual(name = "Country", values = shapePalette[1:9]) + scale_colour_manual(name = "Country", values = colorPalette[1:9]) + theme(legend.key = element_blank(), legend.position = c(.15, .86), legend.background = element_rect(colour = 'black')) + guides(shape = guide_legend(ncol = 3))
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.5.3b, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE, warning = FALSE>>=
ggplot(data = df5.3b, aes(x = Year, y = Public, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Value of public capital (% national income)") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = pretty_breaks(n = 6)) + scale_x_continuous(breaks = seq(1970, 2010, by = 5)) + scale_shape_manual(name = "Country", values = shapePalette[1:9]) + scale_colour_manual(name = "Country", values = colorPalette[1:9]) + theme(legend.key = element_blank(), legend.position = c(.15, .14), legend.background = element_rect(colour = 'black')) + guides(shape = guide_legend(ncol = 3))
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.5.5, out.width='1\\linewidth', out.height='0.75\\textheight', dev='pdf', fig.align='center', cache = TRUE, warning = FALSE>>=
ggplot(data = df5.5, aes(x = Year, y = Capital, group = interaction(variable,Type), shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Value of capital (% national income)") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = pretty_breaks(n = 6)) + scale_x_continuous(breaks = seq(1970, 2010, by = 5)) + scale_shape_manual(name = "Country", values = shapePalette[1:9]) + scale_colour_manual(name = "Country", values = colorPalette[1:9]) + theme(legend.key = element_blank(), legend.position = c(.15, .86), legend.background = element_rect(colour = 'black')) + guides(shape = guide_legend(ncol = 3)) 
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.9.8, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE>>=
ggplot(data = df9.8, aes(x = Year, y = value, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(group = variable, shape = variable, colour = variable), size = 3) + ylab("Share of top decile in national income") + xlab("") + theme_bw() + scale_y_continuous(labels = percent, breaks = seq(.25, .5, by = .05)) + scale_x_continuous(breaks = seq(1900, 2010, by = 10)) + scale_shape_manual(name = "Share of top decile \n in national income", values = shapePalette[1:2]) + scale_colour_manual(name = "Share of top decile \n in national income", values = colorPalette[1:2]) + theme(legend.key = element_blank(), legend.position = c(.6, .75), legend.background = element_rect(colour = 'black')) 
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.14.1, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE, warning = FALSE>>=
ggplot(data = df14.1, aes(x = Year, y = Rate, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Marginal tax rate applying to the highest incomes") + xlab("") + theme_bw() + scale_x_continuous(breaks = seq(1900, 2010, by = 10)) + scale_y_continuous(labels = percent, breaks = seq(0, 1, by = .1)) + scale_shape_manual(name = "Country", values = shapePalette[1:4]) + scale_colour_manual(name = "Country", values = colorPalette[1:4]) + theme(legend.key = element_blank(), legend.position = c(.5, .14), legend.background = element_rect(colour = 'black')) + guides(shape = guide_legend(ncol = 2)) 
@
...
\begin{minipage}[b]{\textwidth}
\centering
<<Figure.14.2, out.width='1\\linewidth', dev='pdf', fig.align='center', cache = TRUE, warning = FALSE>>=
ggplot(data = df14.2, aes(x = Year, y = Rate, group = variable, shape = variable, colour = variable)) + geom_line() + geom_point(aes(shape = variable, colour = variable), size = 3) + ylab("Marginal tax rate applying to the highest inheritances") + xlab("") + theme_bw() + scale_x_continuous(breaks = seq(1900, 2010, by = 10)) + scale_y_continuous(labels = percent, breaks = seq(0, 1, by = .1)) + scale_shape_manual(name = "Country", values = shapePalette[1:4]) + scale_colour_manual(name = "Country", values = colorPalette[1:4]) + theme(legend.key = element_blank(), legend.position = c(.12, .86), legend.background = element_rect(colour = 'black'))  + guides(shape = guide_legend(ncol = 2)) 
@
