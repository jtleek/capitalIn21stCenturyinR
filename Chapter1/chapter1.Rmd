...
```{r load1, message=FALSE, cache=TRUE}
library(xlsx)
...
```{r p1, dependson="load1", fig.height=7, fig.width=8, cache=TRUE, fig.cap=""}
...
```{r, dependson="load1", fig.height=7, fig.width=8, fig.cap=""}
...
```{r load2, message=FALSE, cache=TRUE}
...
```{r, dependson="load2", fig.height=7, fig.width=8, fig.cap=""}
...
```{r load3, message=FALSE, cache=TRUE}
...
```{r load4, message=FALSE, cache=TRUE}
fig45_dat = read.xlsx(
    "../Piketty2014FiguresTables/Chapter1TablesFigures.xlsx", 
