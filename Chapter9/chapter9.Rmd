...
```{r tabTS9.1, dependson="loadCh9", message=FALSE}
## Table TS9.1
...
```{r tabTS8.1copy, dependson="loadCh9", message=FALSE}
...
## Table S8.2 (copied)
```{r tabTS8.2copy, dependson="loadCh9", message=FALSE}
...
```{r tabTS9.2, dependson="loadCh9", message=FALSE}
...
```{r tabTS9.3, dependson="loadCh9", message=FALSE}
