...
## Download the data file into working directory

download.file("http://piketty.pse.ens.fr/files/capital21c/en/xls/Chapter2TablesFigures.xlsx","chapter02.xlsx")


## Table TS2.1

ts21 = read.xlsx("chapter02.xlsx",sheetName="TS2.2",rowIndex=8:17,colIndex=c(25,27:30),header=FALSE)
...
ts22 = read.xlsx("chapter02.xlsx",sheetName="TS2.2",rowIndex=8:20,colIndex=8:9,header=FALSE)
ts22[,3] = 1:13
...
ts23 = read.xlsx("chapter02.xlsx",sheetName="TS2.4",rowIndex=10:16,colIndex=4:6,header=FALSE)
...
ts24 = read.xlsx("chapter02.xlsx",sheetName="TS2.4",rowIndex=7:18,colIndex=c(1,3),header=FALSE)
ts24[,3] = 1:12
...
ts25 = read.xlsx("chapter02.xlsx",sheetName="TS2.4",rowIndex=7:18,colIndex=c(1,2),header=FALSE)
ts25[,3] = 1:12
...
ts26 = read.xlsx("chapter02.xlsx",sheetName="TS2.5",rowIndex=8:14,colIndex=1:5,header=FALSE)
